import { Badge, BlockStack, Box, Button, Card, Checkbox, Grid, Layout, Page, RadioButton, Text, TextField } from '@shopify/polaris'
...
const FreeShipping = () => {
    ...
    const [rewardTitle, setRewardTitle] = useState('Free shipping coupon');
                    ...
                    <Grid>
                        <Grid.Cell columnSpan={{ xs: 6, sm: 4, md: 4, lg: 8, xl: 8 }}>
                            <BlockStack gap={400}>
                                ...
                                <Card>
                                    <BlockStack gap={300}>
                                        <Text variant='headingSm' as="span">Reward</Text>
                                        <TextField
                                            label="Points amount"
                                            type="number"
                                            value={100}
